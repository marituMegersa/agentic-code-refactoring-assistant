...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Code Refactoring & Security Auditor</h1>
      <p style={{ color: '#666' }}>Autonomous multi-agent codebase analysis, automated refactoring, and AST security vulnerability scanner.</p>
